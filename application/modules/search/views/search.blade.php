...
<body class = "flat-back">
    ...
    <div id="content" class="content">
        <div class="row">
            <!-- begin col-12 -->
            <div class="col-12">
                {{ form_open('search/execute_search') }}
                <!-- begin panel -->
                        ...
                        <div class="panel-body">
                                    ...
                                    <table style="width:100%; border-collapse: separate; border-spacing:1em;">
                                        <tr>
                                            <td>
                                                ...
                                                {{ form_input(array('name'=>'PaymentTransactionId', 'value'=>set_value('PaymentTransactionId', $search_array['PaymentTransactionId']), 'placeholder'=>'ID', 'class'=>'form-control'))}}
                                            </td>
                                            <td>
                                                <label>Transaction Begin Date</label>
                                                {{ form_input(array('name'=>'BegDate', 'value'=>set_value('BegDate', $search_array['BegDate']), 'placeholder'=>'Begin Date', 'class'=>'form-control', 'id'=>'datepicker'))}}
                                            </td>
                                            <td>
                                                <label>Transaction End Date</label>
                                                {{ form_input(array('name'=>'EndDate', 'value'=>set_value('EndDate', $search_array['EndDate']), 'placeholder'=>'End Date', 'class'=>'form-control', 'id'=>'datepicker2'))}}
                                            </td>
                                            <td>
                                                <label>Transaction Amount</label>
                                                {{ form_input(array('name'=>'TransactionAmount', 'value'=>set_value('TransactionAmount', $search_array['TransactionAmount']), 'placeholder'=>'Transaction Amount', 'class'=>'form-control'))}}
                                            </td>
                                            <!--<td>
                                                <label>Status</label>
                                                {{ form_dropdown('TransactionStatusId', $transaction_statuses, $search_array['TransactionStatusId'], array('class'=>'form-control'))}}
                                            </td>-->
                                        </tr>
                                        <tr>
                                            <td>
                                                <label>Approval Code</label>
                                                {{ form_input(array('name'=>'AuthCode', 'value'=>set_value('AuthCode', $search_array['AuthCode']), 'placeholder'=>'Approval Code', 'class'=>'form-control'))}}
                                            </td>

                                            <td>
                                                <label>Order Number</label>
                                                {{ form_input(array('name'=>'OrderNumber', 'value'=>set_value('OrderNumber', $search_array['OrderNumber']), 'placeholder'=>'Order Number', 'class'=>'form-control'))}}
                                            </td>

                                            <td>
                                                <label>CVV2 Result</label>
                                                {{ form_input(array('name'=>'CVV2ResponseCode', 'value'=>set_value('CVV2ResponseCode', $search_array['CVV2ResponseCode']), 'placeholder'=>'CVV2 Result', 'class'=>'form-control'))}}
                                            </td>

                                            <td>
                                                <label>Batch Number</label>
                                                {{ form_input(array('name'=>'SerialNumber', 'value'=>set_value('SerialNumber', $search_array['SerialNumber']), 'placeholder'=>'Batch Number', 'class'=>'form-control'))}}
                                            </td>
                                            <td>&nbsp;</td>
                                        </tr>
                                    </table>
                            ...
                            <div class="form-group">
                                <div class="col-md-9">
                                    ...
                                    {{ form_submit('search_submit', 'Submit', "class='btn btn-sm btn-success'", "id='submit'") }}
                                    {{ form_close() }}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                                    <div class="table-responsive">
                                        <table id="myTable" class="table table-bordered tablesorter">
                                            ...
                                            <tbody>
                                                @foreach ($results -> result() as $result)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ date_conversion_nowording($result->InsertDate) }}
                                                        </td>
                                                        <td>
                                                            {{ $result->firstname. ' ' . $result->middleinitial . ' ' . $result->lastname }}
                                                        </td>
                                                        <td>
                                                            {{ $result->email }}
                                                        </td>
                                                        ...
                                                        <td align='right'>
                                                            {{ sprintf('$%01.2f', $result->TransactionAmount) }}
                                                        </td>
                                                        <td>
                                                            {{ $result->AuthCode }}
                                                        </td>
                                                        ...
                                                        <td>
                                                            {{ $result->CVV2ResponseCode . ' ' . $result->CVV2ResponseMessage }}
                                                        </td>
                                                        <td>
                                                            {{ $result->cclast4 }}
                                                        </td>
                                            ...
                                            @else
                                                {{ 'Search resulted with no records found' }}
                                            @endif
                                        @else
                                            {{ 'Please input info to search.' }}
                                        @endif
                        </div>
                    </div>
                </div>
