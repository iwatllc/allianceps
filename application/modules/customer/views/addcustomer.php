...
<div class="row">
        ...
        <div class="form-group well" id="cc_cfpercentage-field">
            ...
            <span class="input-group">
                <span class="input-group-addon">
                    <input type="checkbox" name="cc_conveniencefee" />
                </span>
                    <input type="text" class="form-control cfp" name="cc_cfpercentage" maxlength="5"><span class="input-group-addon cfp">%</span>
    ...
    <div class="col-xs-2">
        <div class="form-group well" id="ach_cfpercentage-field">
            ...
            <span class="input-group">
                <span class="input-group-addon">
                    <input type="checkbox" name="ach_conveniencefee" />
                </span>
                    <input type="text" class="form-control cfp" name="ach_cfpercentage" maxlength="5"><span class="input-group-addon cfp">%</span>
